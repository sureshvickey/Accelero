package com.viki.accelero.kdgaugeview;
...
public class KdGaugeView extends View {
    ...
    private int divisionCircleColor = Color.WHITE;
    private int speedTextColor = Color.WHITE;
    private int speedUnitTextColor = Color.WHITE;
    private int speedLimitTexteColor = Color.WHITE;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mMaxSpeed = a.getFloat(R.styleable.kdgaugeview_maxSpeed, 120);
        ...
        if (TextUtils.isEmpty(unitOfMeasurement)) unitOfMeasurement = "km/h";


        mSpeedTextSize = a.getDimension(R.styleable.kdgaugeview_speedTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, getDisplayMetrics()));
        mSpeedUnitTextSize = a.getDimension(R.styleable.kdgaugeview_unitOfMeasurementTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16, getDisplayMetrics()));
        mSpeedLimitTextSize = a.getDimension(R.styleable.kdgaugeview_speedLimitTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16, getDisplayMetrics()));
...
//            canvas.drawArc(progressBarRect, 0, alertSpeedAngle, false, mSpeedProgressPaint);
        ...
        float y = (float) ((mCircleCenterY - 160) + mDotedCircleRadius * Math.sin(Math.toRadians(-225)));
