...
public class BatteryView extends View {
    ...
    private int dialActiveColor = Color.DKGRAY; //Color.parseColor("#D3D3D3");
    private int dialInactiveColor = Color.TRANSPARENT;//Color.parseColor("#E0E0E0");
    private int dialSpeedColor = Color.RED;
    private int dialSpeedAlertColor = Color.GREEN;
    private int subDivisionCircleColor = Color.TRANSPARENT;
    private int divisionCircleColor = Color.TRANSPARENT;
    private int speedTextColor = Color.WHITE;
    private int speedUnitTextColor = Color.TRANSPARENT;
    private int speedLimitTexteColor = Color.TRANSPARENT;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mMaxSpeed = a.getFloat(R.styleable.kdgaugeview_maxSpeed, 100);
        ...
        if (TextUtils.isEmpty(unitOfMeasurement)) unitOfMeasurement = "%";


        mSpeedTextSize = a.getDimension(R.styleable.kdgaugeview_speedTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 40, getDisplayMetrics()));
        mSpeedUnitTextSize = a.getDimension(R.styleable.kdgaugeview_unitOfMeasurementTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getDisplayMetrics()));
        mSpeedLimitTextSize = a.getDimension(R.styleable.kdgaugeview_speedLimitTextSize, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getDisplayMetrics()));

        speedDialRingWidth = a.getDimension(R.styleable.kdgaugeview_speedDialRingWidth, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getDisplayMetrics()));
        speedDialRingInnerPadding = a.getDimension(R.styleable.kdgaugeview_speedDialRingInnerPadding, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10, getDisplayMetrics()));
...
//            canvas.drawArc(progressBarRect, 0, alertSpeedAngle, false, mSpeedProgressPaint);
        ...
        mSpeedLimitTextPaint.setTextAlign(Paint.Align.LEFT);
        float x_min1 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(-203)));
        float y_min1 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-205)));
        canvas.drawText("" + 10, x_min1 + 10, y_min1 - 10, mSpeedLimitTextPaint);

        mSpeedLimitTextPaint.setTextAlign(Paint.Align.LEFT);
        float x_min2 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(-187)));
        float y_min2 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-184)));
        canvas.drawText("" + 20, x_min2 + 10, y_min2 - 10, mSpeedLimitTextPaint);

        mSpeedLimitTextPaint.setTextAlign(Paint.Align.LEFT);
        float x_min3 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(-159)));
        float y_min3 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-162)));
        canvas.drawText("" + 30, x_min3 + 10, y_min3 - 10, mSpeedLimitTextPaint);

        mSpeedLimitTextPaint.setTextAlign(Paint.Align.LEFT);
        float x_min4 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(-135)));
        float y_min4 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-142)));
        canvas.drawText("" + 40, x_min4 + 10, y_min4 - 10, mSpeedLimitTextPaint);

        mSpeedLimitTextPaint.setTextAlign(Paint.Align.LEFT);
        float x_min5 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(-114)));
        float y_min5 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-130)));
        canvas.drawText("" + 50, x_min5 + 10, y_min5 - 10, mSpeedLimitTextPaint);

        mSpeedLimitTextPaint.setTextAlign(Paint.Align.CENTER);
        float x_min6 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(-92)));
        float y_min6 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-126)));
        canvas.drawText("" + 60, x_min6 + 10, y_min6 - 10, mSpeedLimitTextPaint);

        mSpeedLimitTextPaint.setTextAlign(Paint.Align.RIGHT);
        float x_min7 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(-72)));
        float y_min7 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-130)));
        canvas.drawText("" + 70, x_min7 + 10, y_min7 - 10, mSpeedLimitTextPaint);

        mSpeedLimitTextPaint.setTextAlign(Paint.Align.RIGHT);
        float x_min8 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(-52)));
        float y_min8 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-142)));
        canvas.drawText("" + 80, x_min8 + 10, y_min8 - 10, mSpeedLimitTextPaint);

        mSpeedLimitTextPaint.setTextAlign(Paint.Align.RIGHT);
        float x_min9 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(-32)));
        float y_min9 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-162)));
        canvas.drawText("" + 90, x_min9 + 10, y_min9 - 10, mSpeedLimitTextPaint);

        mSpeedLimitTextPaint.setTextAlign(Paint.Align.RIGHT);
        float x_min10 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(-23)));
        float y_min10 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-184)));
        canvas.drawText("" + 100, x_min10 + 10, y_min10 - 10, mSpeedLimitTextPaint);

        mSpeedLimitTextPaint.setTextAlign(Paint.Align.RIGHT);
        float x_min11 = (float) (mCircleCenterX + mDotedCircleRadius * Math.cos(Math.toRadians(32)));
        float y_min11 = (float) (mCircleCenterY + mDotedCircleRadius * Math.sin(Math.toRadians(-205)));
        canvas.drawText("" + 110, x_min11 + 10, y_min11 - 10, mSpeedLimitTextPaint);
        ...
        canvas.drawText("" + (int) mCurrentSpeed +"%", mCircleCenterX, (mCircleCenterY-60) - ((mSpeedTextPaint.descent() + mSpeedTextPaint.ascent()) / 2), mSpeedTextPaint);


//        //Draw speed unit text
//        float x = mCircleCenterX;
//        float y = (float) ((mCircleCenterY-120) + mDotedCircleRadius * Math.sin(Math.toRadians(-225)));
//
